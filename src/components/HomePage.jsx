...
//         <div className="bg-gray-200 h-40 mt-4">[Metrics Visualization Placeholder]</div>
//       </div>
...
//         <div className="bg-gray-200 h-40 mt-4">[Waste Level Data Visualization Placeholder]</div>
//       </div>
...
//         <div className="bg-gray-200 h-40 mt-4">[Interactive Map Placeholder]</div>
//       </div>
//     </div>
//   </div>
// );
  ...
  <div className="text-center p-8">
    ...
    <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
      ...
      <div className="mb-8 md:mb-0 bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <img src="/images/metric.jpeg" alt="Key Metrics Visualization" className="w-full object-cover h-40" />
      </div>
      ...
      <div className="mb-8 md:mb-0 bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <p className="p-4">Interactive map showing optimized routes for waste collection to maximize efficiency and reduce carbon footprint.</p>
        {/* Image below the description */}
        <img src="/images/route.jpeg" alt="Route Optimization Visualization" className="w-full object-cover h-40" />
      </div>
    </div>
  </div>
);
